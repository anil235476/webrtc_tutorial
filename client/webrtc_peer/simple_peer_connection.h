...
#ifndef _WEBRTC_SIMPLE_PEER_CONNECTION_H_
#define _WEBRTC_SIMPLE_PEER_CONNECTION_H_
...
namespace webrtc_peer {
	...
	public:
		...
		bool InitializePeerConnection(const turn_addresses_list& addresses,
			bool is_receiver);
...
#endif  // _WEBRTC_SIMPLE_PEER_CONNECTION_H_
